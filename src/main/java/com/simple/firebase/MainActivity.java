...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        private void saveDatabaseFirebase() {
            ...
            Toast.makeText(this, "dData tidak boleh kosong", Toast.LENGTH_SHORT);
        } else{
                getReference.child("Admin").child("17020147").child("Nama").push()
                        ...
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                nama.setText("");
                                jurusan.setText("");
                           Toast.makeText(MainActivity.this,"Data Tersimpan",Toast.LENGTH_SHORT) ;
                            }
                        });
                }
        }}
